...
const Tentang = () => {
    return ( 
        ...
        <div className="flex sm:flex-col sm:items-center xl:flex-row xl:items-start justify-evenly py-32 bg-gray-50">
            <div className="text-center sm:w-full xl:w-1/3 min-h-[662px]  p-20 rounded-2xl shadow border transition bg-white">
            ...
            <div className="text-center sm:w-full xl:w-1/3 min-h-[662px] p-20 shadow rounded-2xl border transition bg-white">
